...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_typegoose__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_typegooseTools__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_typegoose__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_typegoose___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_typegoose__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_validator__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__domain_User__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__util_typegooseTools__ = __webpack_require__(3);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = UserSchema;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0_typegoose__["prop"])({ required: true, unique: true, minlength: 1, maxlength: 256, validate: (value) => Object(__WEBPACK_IMPORTED_MODULE_1_validator__["isEmail"])(value) }),
    __metadata("design:type", String)
], UserSchema.prototype, "email", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0_typegoose__["prop"])({ required: true, minlength: 1, maxlength: 256 }),
    __metadata("design:type", String)
...
class User {
    constructor(distinctId, email, name, thumbnail, permission = Permission.LOW, id) {
        this.id = id;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_mongoose__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__nuxt_config__ = __webpack_require__(11);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_body_parser__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_express_session__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__category__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__item__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_http_status_codes__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_http_status_codes___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_http_status_codes__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__schemas_ItemSchema__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__LocalSchema__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__UserSchema__ = __webpack_require__(6);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0_typegoose__["prop"])({ required: true, ref: __WEBPACK_IMPORTED_MODULE_4__UserSchema__["b" /* UserSchema */] }),
    __metadata("design:type", Object)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_http_status_codes__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_http_status_codes___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_http_status_codes__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__schemas_LocalSchema__ = __webpack_require__(5);
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_http_status_codes__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_http_status_codes___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_http_status_codes__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__schemas_UserSchema__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__domain_User__ = __webpack_require__(7);
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
router.get('/', (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        const users = yield __WEBPACK_IMPORTED_MODULE_2__schemas_UserSchema__["a" /* UserModel */].find({ permission: __WEBPACK_IMPORTED_MODULE_3__domain_User__["a" /* Permission */].LOW }).exec();
        res.json(users);
    }
    catch (error) {
        res.status(__WEBPACK_IMPORTED_MODULE_1_http_status_codes__["INTERNAL_SERVER_ERROR"]).end(Object(__WEBPACK_IMPORTED_MODULE_1_http_status_codes__["getStatusText"])(__WEBPACK_IMPORTED_MODULE_1_http_status_codes__["INTERNAL_SERVER_ERROR"]));
...
router.get('/employees', (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        const employees = yield __WEBPACK_IMPORTED_MODULE_2__schemas_UserSchema__["a" /* UserModel */].find({ permission: __WEBPACK_IMPORTED_MODULE_3__domain_User__["a" /* Permission */].HIGH }).exec();
        res.json(employees);
    }
    catch (error) {
        res.status(__WEBPACK_IMPORTED_MODULE_1_http_status_codes__["INTERNAL_SERVER_ERROR"]).end(Object(__WEBPACK_IMPORTED_MODULE_1_http_status_codes__["getStatusText"])(__WEBPACK_IMPORTED_MODULE_1_http_status_codes__["INTERNAL_SERVER_ERROR"]));
...
router.post('/', (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        const newUser = yield new __WEBPACK_IMPORTED_MODULE_2__schemas_UserSchema__["a" /* UserModel */](req.body).save();
        res.json(newUser);
    }
    catch (error) {
        res.status(__WEBPACK_IMPORTED_MODULE_1_http_status_codes__["INTERNAL_SERVER_ERROR"]).end(Object(__WEBPACK_IMPORTED_MODULE_1_http_status_codes__["getStatusText"])(__WEBPACK_IMPORTED_MODULE_1_http_status_codes__["INTERNAL_SERVER_ERROR"]));
...
router.put('/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        const modifiedUser = yield __WEBPACK_IMPORTED_MODULE_2__schemas_UserSchema__["a" /* UserModel */]
            .findOneAndUpdate({ _id: req.params.id }, req.body, { new: true })
            .exec();
...
router.delete('/:id', (req, res) => {
    __WEBPACK_IMPORTED_MODULE_2__schemas_UserSchema__["a" /* UserModel */].remove({ _id: req.params.id }).exec()
        .then(() => {
        res.end();
    })
        .catch((error) => {
