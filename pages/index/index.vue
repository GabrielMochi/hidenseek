      ...
      <v-flex v-for="item in items" :key="item.id" xs12 sm6 md4 lg3 xl2>
        ...
        <v-card class="item-card">
            <v-card-media class="container-overlay" contain @click.native="onItemSelected(item.id)" @>
              ...
              <div class="overlay">
                <v-btn block flat color="black" class="text blur-button" to="retrieve">Reivindicar</v-btn>
              </div>
            </v-card-media>
        <v-expansion-panel> 
              ...
              <v-list>
                ...
                <v-list-tile v-show="isMobile">
                  <v-list-tile-content class="text-xs-center">
                    <v-btn block outline color="secondary" @click.native="onItemSelected(item.id)" to="retrieve">Reivindicar</v-btn>
                  </v-list-tile-content>
                </v-list-tile>
              </v-list>
            </v-expansion-panel-content>
